...
app.post('/cards', function(req, res, next) {
  var info = req.body;
  FlashCardModel.create(info).then(function(card) {
    res.json(card);
  }).then(null, next);
...
app.put('/cards/:flashCardId', function (req, res, next) {
  FlashCardModel.findById(req.body.id).save({question: req.body.question, category: req.body.category, answers: req.body.answers}, function(err, article){
    res.send(article);
  })
})
